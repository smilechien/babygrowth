...
' --- Summary (beautified table rows; minimal-risk HTML) ---
Response.Write "<tr><td colspan='6' style='padding:10px; font-family:Arial,sans-serif;'>" & vbCrLf

Response.Write "<table style='width:100%; border-collapse:collapse; background:#fff; border:1px solid #ddd; border-radius:10px; overflow:hidden;'>" & vbCrLf
Response.Write "  <tr style='background:#f5f7fb;'>" & vbCrLf
Response.Write "    <td colspan='2' style='padding:12px 14px; font-size:22px; font-weight:bold; color:#111;'>Summary</td>" & vbCrLf
Response.Write "  </tr>" & vbCrLf

' Header line: gender/month
Response.Write "  <tr>" & vbCrLf
Response.Write "    <td style='padding:10px 14px; width:34%; border-top:1px solid #eee; color:#444;'>Gender / Month</td>" & vbCrLf
Response.Write "    <td style='padding:10px 14px; border-top:1px solid #eee; font-size:16px; color:#111;'>" & _
              "<span style='color:#b00000; font-weight:bold;'>" & Server.HTMLEncode(Request("gender")) & _
              "</span> &nbsp; Month: <b>" & Server.HTMLEncode(Request("month")) & "</b> " & _
              "<span style='color:#666;'>(compared to norm, n=50)</span></td>" & vbCrLf
Response.Write "  </tr>" & vbCrLf

' Height
Response.Write "  <tr>" & vbCrLf
Response.Write "    <td style='padding:10px 14px; border-top:1px solid #eee; color:#444;'>Height</td>" & vbCrLf
Response.Write "    <td style='padding:10px 14px; border-top:1px solid #eee; font-size:16px;'>" & _
              "<b>" & mh2 & " cm</b> &nbsp; <span style='color:#b00000; font-weight:bold;'>" & percentile_h & "</span> percentile</td>" & vbCrLf
Response.Write "  </tr>" & vbCrLf

' Weight
Response.Write "  <tr>" & vbCrLf
Response.Write "    <td style='padding:10px 14px; border-top:1px solid #eee; color:#444;'>Weight</td>" & vbCrLf
Response.Write "    <td style='padding:10px 14px; border-top:1px solid #eee; font-size:16px;'>" & _
              "<b>" & mw2 & " kg</b> &nbsp; <span style='color:#b00000; font-weight:bold;'>" & percentile_w & "</span> percentile</td>" & vbCrLf
Response.Write "  </tr>" & vbCrLf

' Head circumference
Response.Write "  <tr>" & vbCrLf
Response.Write "    <td style='padding:10px 14px; border-top:1px solid #eee; color:#444;'>Head Circumference</td>" & vbCrLf
Response.Write "    <td style='padding:10px 14px; border-top:1px solid #eee; font-size:16px;'>" & _
              "<b>" & mhc2 & " cm</b> &nbsp; <span style='color:#b00000; font-weight:bold;'>" & percentile_hc & "</span> percentile</td>" & vbCrLf
Response.Write "  </tr>" & vbCrLf

' Cohesion
Response.Write "  <tr>" & vbCrLf
Response.Write "    <td style='padding:10px 14px; border-top:1px solid #eee; color:#444;'>Cohesion (Fit to Norm)</td>" & vbCrLf
Response.Write "    <td style='padding:10px 14px; border-top:1px solid #eee; font-size:16px;'>" & _
              "<b>" & Round(1/(1+a_i),2) & "</b> &nbsp; <span style='color:#b00000; font-weight:bold;'>" & percentile_ai & "</span> percentile</td>" & vbCrLf
Response.Write "  </tr>" & vbCrLf

' BMI
Response.Write "  <tr>" & vbCrLf
Response.Write "    <td style='padding:10px 14px; border-top:1px solid #eee; color:#444;'>BMI</td>" & vbCrLf
Response.Write "    <td style='padding:10px 14px; border-top:1px solid #eee; font-size:16px;'><b>" & BMI & "</b></td>" & vbCrLf
Response.Write "  </tr>" & vbCrLf

' Alert note row
Response.Write "  <tr style='background:#fff7e6;'>" & vbCrLf
Response.Write "    <td style='padding:10px 14px; border-top:1px solid #eee; color:#7a5d00; font-weight:bold;'>Alert rule</td>" & vbCrLf
Response.Write "    <td style='padding:10px 14px; border-top:1px solid #eee; color:#7a5d00; font-size:14px;'>" & _
              "Cohesion(&lt; 0.2) &amp; Misfit Percentile(&lt; 10th percentile)</td>" & vbCrLf
Response.Write "  </tr>" & vbCrLf
...
<a href="sildfeng.asp" style="font-size: 28px;">🔙 Return</a>
